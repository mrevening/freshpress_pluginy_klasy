...
function rejsm_eq5d_init() {
    ...
    $args = array(
        'labels'             => $labels,
        'description'        => __( 'Skala wpływu stwardnienia rozsianego (EQ-5D).', 'your-plugin-textdomain' ),
...
function eq5d_lista_pytan ()
{
    $lista_pytan_eq5d = array(
        ...
        'Nie mam problemów z wykonywaniem moich zwykłych czynności',
        ...
        'Jestem umiarkowanie niespokojny lub przygnębiony',
...
function rejsm_eq5d_create() {
	...
	add_meta_box( 'eq5d_1', 'Zdolność poruszania się', 'rejsm_eq5d_add_metabox_1', 'eq5d', 'normal', 'high' );
    add_meta_box( 'eq5d_2', 'Samoopieka', 'rejsm_eq5d_add_metabox_2', 'eq5d', 'normal', 'high' );
    add_meta_box( 'eq5d_3', 'Zwykła działalność (np. praca, nauka, zajęcia domowe, aktywność rodzinna, zajęcia w czasie wolnym)', 'rejsm_eq5d_add_metabox_3', 'eq5d', 'normal', 'high' );
    add_meta_box( 'eq5d_4', 'Ból/Dyskomfort', 'rejsm_eq5d_add_metabox_4', 'eq5d', 'normal', 'high' );
    add_meta_box( 'eq5d_5', 'Niepokój/Przygnębienie', 'rejsm_eq5d_add_metabox_5', 'eq5d', 'normal', 'high' );
...
function add_taxonomy_terms_eq5d_kategoria () {
    wp_insert_term ('bardzo złe', 'kategoria_eq5d', array( 'description' => 'bardzo złe samopoczucie', 'slug' => '1 – 25' ));
    wp_insert_term ('złe', 'kategoria_eq5d', array( 'description' => 'złe samopoczucie', 'slug' => '26 – 50' ));
