...
//        $pesel = get_user_meta( $userid, 'pesel', true );
        ...
        $plec = 0;
        if ( substr( $pesel, 8, 1) % 2 == 0 ) $plec = 1;
        else if ( substr( $pesel, 8, 1) % 2 == 1 ) $plec = 2;
    ...
    ?>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <select id="przebieg_choroby" name="key_przebieg_choroby">
                        <option value="0" <?php selected( '0', $przebieg_choroby); ?>></option>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="MyDate" name="key_data_pierwszych_objawow" value=""  <?php echo $data_pierwszych_objawow; ?> />
                </td>
            </tr>
            <tr>
                <th scope="row">Data rozpoznania choroby (miesiąc / rok</th>
                <td>
                    <input type="text" class="MyDate" name="key_data_rozpoznania_choroby" value="" <?php echo $data_rozpoznania_choroby; ?> />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select id="badanie_mri" name="key_badanie_mri">
                        <option value="0" <?php selected( '0', $badanie_mri); ?>></option>
            ...
            <tr>
                ...
                <td>
                    <select id="badanie_plynu" name="key_badanie_plynu">
                        <option value="0" <?php selected( '0', $badanie_plynu); ?>></option>
            ...
            <tr>
                ...
                <td>
                    <select id="leczenie_immunomodulujące" name="key_leczenie_immunomodulujące">
                        <option value="0" <?php selected( '0', $leczenie_immunomodulujace); ?>></option>
            ...
            <tr>
                ...
                <td>
                    <select id="leczenie_objawowe" name="key_leczenie_objawowe">
                        <option value="0" <?php selected( '0', $leczenie_objawowe); ?>></option>
...
function rejsm_update_dane_demograficzne_metadata( $userid ) {
    ...
    if( isset( $_POST['key_badanie_mri'] ) ) {
        ...
        update_user_meta( $userid, 'data_badanie_mri', $var_badanie_mri);
    }
    if( isset( $_POST['key_badanie_plynu'] ) ) {
        $var_data_badanie_plynu = $_POST['key_badanie_plynu'];
        update_user_meta( $userid, 'data_badanie_plynu', $var_data_badanie_plynu);
    }
    if( isset( $_POST['key_badanie_plynu'] ) ) {
        $var_data_badanie_plynu = $_POST['key_badanie_plynu'];
        update_user_meta( $userid, 'data_badanie_plynu', $var_data_badanie_plynu);
    ...
    if( isset( $_POST['key_leczenie_immunomodulujace'] ) ) {
        $var_data_leczenie_immunomodulujace = $_POST['key_leczenie_immunomodulujace'];
        update_user_meta( $userid, 'data_leczenie_immunomodulujace', $var_data_leczenie_immunomodulujace);
    }
    if( isset( $_POST['key_leczenie_objawowe'] ) ) {
        $var_data_leczenie_objawowe = $_POST['key_leczenie_objawowe'];
        update_user_meta( $userid, 'data_leczenie_objawowe', $var_data_leczenie_objawowe);
    }
}
?>
